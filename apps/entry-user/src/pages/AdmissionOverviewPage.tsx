    ...
    <PageContainer>
      <Flex width="fit-content" height="fit-content" isColumn gap={32}>
        <Flex width="fit-content" height="fit-content" isColumn gap={12}>
          ...
          <SubTitle>2026학년도 신입생 전형 일정</SubTitle>
        </Flex>
        <TableContainer>
          <TableImage
            src={ADMISSION_OVERVIEW}
            alt="2026학년도 신입생 전형 일정표"
          />
        </TableContainer>
        <AttachmentSection>
          <AttachmentTable>
            <AttachmentRow>
              ...
              <AttachmentContent>
                <AttachmentLink
                  href="https://entrydsm.kr/2026%ED%95%99%EB%85%84%EB%8F%84%20%EB%8C%80%EB%8D%95%EC%86%8C%ED%94%84%ED%8A%B8%EC%9B%A8%EC%96%B4%EB%A7%88%EC%9D%B4%EC%8A%A4%ED%84%B0%EA%B3%A0%EB%93%B1%ED%95%99%EA%B5%90%20%EC%8B%A0%EC%9E%85%EC%83%9D%20%EC%9E%85%ED%95%99%EC%A0%84%ED%98%95%EC%9A%94%EA%B0%95.pdf"
                  download
                >
                  2026학년도 신입생 전형 요강.pdf
                  <IconWrapper>
                    <DownloadIcon />
                  </IconWrapper>
                </AttachmentLink>
